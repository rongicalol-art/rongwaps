...
import { AppIcon, ContextualChineseText, IconActionButton } from '../../../lib/widgets';
...
export function GrammarInteractiveSentence({
  ...
  return (
    <div className="border-t border-ui-divider px-5 py-5 sm:px-7 sm:py-6">
      ...
      <p className="mt-4 rounded-compact bg-brand-primary/5 px-4 py-3 text-sm font-bold leading-6 text-ui-muted-strong">
        <GrammarFocusText
          text={choice.note}
