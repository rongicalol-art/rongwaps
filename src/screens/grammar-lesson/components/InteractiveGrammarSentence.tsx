            ...
            <AnimatePresence>
              {isOpen && (
                <motion.span
                  ...
                  className="pointer-events-none absolute bottom-[calc(100%+9px)] left-1/2 z-40 w-max min-w-[112px] max-w-[180px] -translate-x-1/2 rounded-control border-b-[length:var(--depth-sm)] border-ui-border bg-ui-ink-strong px-3 py-2 text-center"
                >
