...
import { ContextualChineseText, SegmentedControl } from '../../../lib/widgets';
...
export function SentenceSpine({
  ...
  return (
    <GrammarLabShell
      ...
      {...props}
    >
      <div className="overflow-hidden rounded-feature border-b-[length:var(--depth-md)] border-ui-border bg-ui-surface">
