...
import { ActionButton, AppIcon, SegmentedControl } from '../../../lib/widgets';
  ...
  return (
    <>
      ...
      >
        <div
          ref={dockRef}
          className="pointer-events-auto relative flex w-full max-w-[300px] items-center justify-center"
          onBlur={(event) => {
