...
export const BreakdownSkeleton: React.FC = () => {
  return (
    <div className="w-full flex flex-col gap-6 pb-8 animate-pulse">
      ...
      <div className="bg-white border-2 border-b-[6px] border-[#E5E5E5] rounded-[24px] p-6 flex flex-row items-center justify-between gap-4">
        ...
        <Skeleton className="w-[110px] h-[110px] shrink-0 rounded-[24px] bg-[#F7F7F7] border-2 border-b-2 border-[#E5E5E5]" />
      </div>

      {/* Meaning & Course Usages Skeleton */}
      <div className="bg-white border-2 border-b-[6px] border-[#E5E5E5] rounded-[24px] p-4 sm:p-5 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 min-[480px]:grid-cols-3 sm:grid-cols-4 gap-3">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="w-full bg-white rounded-[20px] p-3 flex flex-col items-center justify-center border-2 border-[#E5E5E5] border-b-[6px] min-h-[120px]">
